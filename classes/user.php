<?php
    ...
    class User extends Database{
        public function createUser($first_name, $last_name, $uname, $pass, $photo){
            // encrypting the password using password_hash()
            // PASSWORD_DEFAULT is the encrypting method that we are using
            $pass = password_hash($pass, PASSWORD_DEFAULT);

            $sql = "INSERT INTO users(first_name, last_name, username, password, photo)
                    VALUES ('$first_name', '$last_name', '$uname', '$pass', '$photo')";
